...
Audited 305 saved runs. **0 pass the chosen screen.**

Existing training filter: 293 runs. Nonfinite field archives: 12.
...
|---|---:|---:|---:|---:|
| All fluid: maximum Mach | 0.275 | 0.379 | 0.697 | 0.961 |
| All fluid: maximum density deviation (%) | 19.847 | 25.369 | 59.643 | 129.967 |
| Without inlet/outlet columns: maximum Mach | 0.275 | 0.379 | 0.697 | 0.916 |
| Without inlet/outlet columns: maximum density deviation (%) | 9.672 | 14.862 | 51.046 | 129.967 |

Prescribed inlet Mach range: 0.173205 to 0.173205.
...
## Boundary-stage limitation

The current exporter saves moments after streaming, before boundary reconstruction. The additional measurements excluding x=0 and x=nx-1 diagnose that known issue; they do not replace the whole-fluid acceptance check or exclude wall-adjacent cells.
